...
class NoiseReduction:
    ...
    def noiseFiltering(self, mode: bool, soundFile, fileSpecification, audioFiles=None):
        with contextlib.closing(wave.open(audioFiles if mode else soundFile, 'rb')) as spf:
            ...
            wav_file = wave.open(fileSpecification, "w")
